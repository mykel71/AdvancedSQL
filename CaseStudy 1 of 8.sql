...
--8 weeks of Case Studies problems
...
--Danny’s Diner is in need of your assistance to help the restaurant stay afloat - the restaurant has captured some
...
Example Datasets
All datasets exist within the diner database schema - be sure to include this reference within your SQL scripts 
as you start exploring the data and answering the case study questions.
...
You can use the embedded DB Fiddle below to easily access these example datasets - this interactive session has 
everything you need to start solving these questions using SQL.

You can click on the Edit on DB Fiddle link on the top right hand corner of the embedded session below and 
it will take you to a fully functional SQL editor where you can write your own queries to analyse the data.

You can feel free to choose any SQL dialect you’d like to use, the existing Fiddle is using PostgreSQL 13 as default.

Serious SQL students have access to a dedicated SQL script in the 8 Week SQL Challenge section of the course which they can use to 
generate relevant temporary tables like we’ve done throughout the entire course!


CREATE SCHEMA diner;
SET search_path = dannys_diner;

CREATE TABLE diner.Sales (
  "customer_id" VARCHAR(1),
  "order_date" DATE,
  "product_id" INTEGER
);

INSERT INTO diner.Sales
...
CREATE TABLE diner.Menu (
  "product_id" INTEGER,
  "product_name" VARCHAR(5),
  "price" INTEGER
);

INSERT INTO diner.Menu
  ("product_id", "product_name", "price")
VALUES
  ('1', 'sushi', '10'),('2', 'curry', '15'),('3', 'ramen', '12');
  

CREATE TABLE diner.Members (
  "customer_id" VARCHAR(1),
  "join_date" DATE
);

INSERT INTO diner.Members
